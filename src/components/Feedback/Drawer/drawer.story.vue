    ...
    <Variant title="Basic Usage" :source="basicSource">
      ...
      <Teleport to="#app">
        <el-drawer
          ...
          :open-delay="basicDrawerData.openDelay"
          :close-delay="basicDrawerData.closeDelay"
          :distroy-on-close="basicDrawerData.distroyOnClose"
          :modal="basicDrawerData.modal"
          :direction="basicDrawerData.direction"
          :show-close="basicDrawerData.showClose"
          :size="basicDrawerData.size"
      ...
      <template #controls>
        <HstCheckbox
          v-model="basicDrawerData.closeOnClickModal"
          title="Close-on-click-modal"
        />
        <HstCheckbox
          v-model="basicDrawerData.closeOnPressEscape"
        ...
        <HstCheckbox
          v-model="basicDrawerData.distroyOnClose"
          title="Distroy-on-close"
        />
        <HstCheckbox v-model="basicDrawerData.modal" title="Modal" />
        <HstRadio
          v-model="basicDrawerData.direction"
          title="Direction"
          :options="basicDrawerData.directionList"
        />
    ...
    <Variant title="Customized Drawer" :source="customizedSource">
      ...
      <Teleport to="#app">
        <el-drawer
          ...
          :open-delay="customizedDrawerData.openDelay"
          :close-delay="customizedDrawerData.closeDelay"
          :distroy-on-close="customizedDrawerData.distroyOnClose"
          :modal="customizedDrawerData.modal"
          :direction="customizedDrawerData.direction"
          :show-close="customizedDrawerData.showClose"
          :size="customizedDrawerData.size"
      ...
      <template #controls>
        ...
        <HstCheckbox
          v-model="customizedDrawerData.closeOnClickModal"
          title="Close-on-click-modal"
        />
        <HstCheckbox
          v-model="customizedDrawerData.closeOnPressEscape"
          title="Close-on-press-escape"
        />
        <HstNumber
          v-model="customizedDrawerData.openDelay"
          title="Open-delay"
        />
        <HstNumber
          v-model="customizedDrawerData.closeDelay"
          title="Close-delay"
        />
        <HstCheckbox
          v-model="customizedDrawerData.distroyOnClose"
          title="Distroy-on-close"
        />
        <HstCheckbox v-model="customizedDrawerData.modal" title="Modal" />
        <HstRadio
          v-model="customizedDrawerData.direction"
          title="Direction"
          :options="customizedDrawerData.directionList"
        />
        <HstCheckbox
          v-model="customizedDrawerData.showClose"
          title="Show-close"
        />
        <HstText v-model="customizedDrawerData.size" title="Size" />
        <HstText v-model="customizedDrawerData.title" title="Title" />
        <HstCheckbox
          v-model="customizedDrawerData.withHeader"
          title="With-header"
        />
      </template>
    </Variant>
    <Variant title="Nested Drawer" :source="nestedSource">
      ...
      <Teleport to="#app">
        <el-drawer
          ...
          :open-delay="nestedDrawerData.openDelay"
          :close-delay="nestedDrawerData.closeDelay"
          :distroy-on-close="nestedDrawerData.distroyOnClose"
          :modal="nestedDrawerData.modal"
          :direction="nestedDrawerData.direction"
          :show-close="nestedDrawerData.showClose"
          :size="nestedDrawerData.size"
        ...
        >
          <template #default>
            <el-drawer
              v-model="nestedDrawerData.internalVModel"
              size="20%"
              title="Internal drawer"
              :append-to-body="true"
              :before-close="handleClose"
      ...
      <template #controls>
        <HstCheckbox
          v-model="nestedDrawerData.closeOnClickModal"
          title="Close-on-click-modal"
        />
        <HstCheckbox
          v-model="nestedDrawerData.closeOnPressEscape"
          title="Close-on-press-escape"
        />
        ...
        <HstCheckbox
          v-model="nestedDrawerData.distroyOnClose"
          title="Distroy-on-close"
        />
        <HstCheckbox v-model="nestedDrawerData.modal" title="Modal" />
        <HstRadio
          v-model="nestedDrawerData.direction"
          title="Direction"
          :options="nestedDrawerData.directionList"
        />
        ...
        <HstCheckbox
          v-model="nestedDrawerData.withHeader"
          title="With-header"
        />
      </template>
    </Variant>
